    ...
    def _split_generators(self, dl_manager) -> List[datasets.SplitGenerator]:
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "filepath": os.path.join(self.config.data_dir, "train.jsonl"),
                    "split": "train",
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "filepath": os.path.join(self.config.data_dir, "test.jsonl"),
                    "split": "test",
                },
            ),
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "filepath": os.path.join(self.config.data_dir, "validation.jsonl"),
                    "split": "dev",
                },
            ),
        ]
